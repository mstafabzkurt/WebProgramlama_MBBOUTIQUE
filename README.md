# WEB PROGRAMLAMA 2.ÖDEV -- MB BOUTIQUE 
...
- 600px-1023px : Tablet görümünde ürün grid'i 2 sütun şeklinde.
- 600px ve altı : Mobil görünümde ürün grid'i 1 sütun şeklinde.
*Tamamı responsive hale getirmek için kullanıldı*

## **ÖĞRENDİKLERİM**
- :root kullanarak renk ve gölge gibi değerleri tek bir yerden yönetmeyi, bunun tasarımı daha tutarlı hale getirdiğini öğrendim.
- Grid ve Flex düzenlerin hangi durumlarda daha efektif olduğunu öğrendim.
- Hover ve Active efektleri ile kullanıcı etkileşimindeki hissiyatların nasıl değiştini, ayarlandığını öğrendim.
